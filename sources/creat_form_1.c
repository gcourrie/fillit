...
/*   Updated: 2016/01/18 15:26:12 by gcourrie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		creat_a(t_map *maplist, int i, int x)
{
	...
	if (maplist->map[x] == '.' && maplist->map[x + 1] == '.'
		&& maplist->map[x + size] == '.' && maplist->map[x + size + 1] &&
		(x / size) == ((x + 1) / size))
	{
		maplist->map[x] = i + 'A';
		maplist->map[x + 1] = i + 'A';
...
int		creat_d(t_map *maplist, int i, int x)
{
	...
	if (maplist->map[x] == '.' && maplist->map[x + 1] == '.'
		&& maplist->map[x + 2] == '.' && maplist->map[x + size + 2] &&
		(x / size) == ((x + 2) / size))
	{
		maplist->map[x] = i + 'A';
		maplist->map[x + 1] = i + 'A';
...
int		creat_e(t_map *maplist, int i, int x)
{
	...
	if (maplist->map[x] == '.' && maplist->map[x + 1] == '.'
		&& maplist->map[x + 2] == '.' && maplist->map[x + size] &&
		(x / size) == ((x + 2) / size))
	{
		maplist->map[x] = i + 'A';
		maplist->map[x + 1] = i + 'A';
